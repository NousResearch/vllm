...
- [EAGLE](eagle.md)
- [DFlash (Block-Diffusion Draft)](dflash.md)
...
| DFlash | High gain | High gain | Block-diffusion draft; needs a trained draft + bf16 KV cache. Beat MTP across all regimes on Nemotron Ultra 550B. |
